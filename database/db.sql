USE [master]
GO
/****** Object:  Database [ClothesShop]    Script Date: 7/20/2025 6:11:34 PM ******/
...
USE [ClothesShop]
GO
/****** Object:  Table [dbo].[Categories]    Script Date: 7/20/2025 6:11:35 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[OrderItem]    Script Date: 7/20/2025 6:11:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Orders]    Script Date: 7/20/2025 6:11:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Payments]    Script Date: 7/20/2025 6:11:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Products]    Script Date: 7/20/2025 6:11:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Suppliers]    Script Date: 7/20/2025 6:11:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Types]    Script Date: 7/20/2025 6:11:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 7/20/2025 6:11:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (1, 9, CAST(249.00 AS Decimal(10, 2)), 1, 1)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (2, 3, CAST(179.00 AS Decimal(10, 2)), 2, 2)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (3, 2, CAST(315.00 AS Decimal(10, 2)), 5, 2)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (4, 4, CAST(699.00 AS Decimal(10, 2)), 7, 3)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (5, 1, CAST(1596.00 AS Decimal(10, 2)), 9, 3)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (6, 2, CAST(1569.40 AS Decimal(10, 2)), 9, 4)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (7, 2, CAST(315.00 AS Decimal(10, 2)), 5, 4)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (8, 2, CAST(179.00 AS Decimal(10, 2)), 2, 4)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (9, 2, CAST(1100.00 AS Decimal(10, 2)), 11, 5)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (10, 1, CAST(875.00 AS Decimal(10, 2)), 6, 6)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (11, 1, CAST(315.00 AS Decimal(10, 2)), 5, 6)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (12, 1, CAST(1053.00 AS Decimal(10, 2)), 10, 7)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (13, 1, CAST(875.00 AS Decimal(10, 2)), 6, 8)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (14, 1, CAST(875.00 AS Decimal(10, 2)), 6, 9)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (15, 1, CAST(280.50 AS Decimal(10, 2)), 8, 10)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (16, 1, CAST(280.50 AS Decimal(10, 2)), 8, 11)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (17, 2, CAST(280.50 AS Decimal(10, 2)), 8, 12)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (18, 1, CAST(950.00 AS Decimal(10, 2)), 37, 13)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (19, 2, CAST(555.00 AS Decimal(10, 2)), 12, 14)
GO
INSERT [dbo].[OrderItem] ([order_item_id], [quantity], [price], [product_id], [order_id]) VALUES (20, 10, CAST(555.00 AS Decimal(10, 2)), 12, 15)
GO
SET IDENTITY_INSERT [dbo].[OrderItem] OFF
GO
SET IDENTITY_INSERT [dbo].[Orders] ON 
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (1, CAST(N'2025-03-10T12:30:00.000' AS DateTime), CAST(2241.00 AS Decimal(10, 2)), 1, N'tuancsp1505', 1)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (2, CAST(N'2019-05-19T11:30:00.000' AS DateTime), CAST(1167.00 AS Decimal(10, 2)), 1, N'tuancsp1505', 1)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (3, CAST(N'2019-07-20T11:19:00.000' AS DateTime), CAST(4396.00 AS Decimal(10, 2)), 1, N'tuancsp1505', 1)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (4, CAST(N'2020-01-19T11:30:00.000' AS DateTime), CAST(2317.00 AS Decimal(10, 2)), 1, N'user2', 1)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (5, CAST(N'2025-01-19T11:30:00.000' AS DateTime), CAST(2200.00 AS Decimal(10, 2)), 1, N'user2', 1)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (6, CAST(N'2024-06-10T12:30:00.000' AS DateTime), CAST(1190.00 AS Decimal(10, 2)), 1, N'tuancsp1505', 1)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (7, CAST(N'2022-02-10T12:30:00.000' AS DateTime), CAST(1053.00 AS Decimal(10, 2)), 1, N'tuancsp1505', 1)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (8, CAST(N'2021-02-10T12:30:00.000' AS DateTime), CAST(875.00 AS Decimal(10, 2)), 1, N'tuancsp1505', 1)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (9, CAST(N'2020-02-14T12:30:00.000' AS DateTime), CAST(875.00 AS Decimal(10, 2)), 1, N'admin123', 1)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (10, CAST(N'2025-07-17T17:59:15.000' AS DateTime), CAST(280.50 AS Decimal(10, 2)), 1, N'user2', 1)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (11, CAST(N'2025-07-17T18:04:13.000' AS DateTime), CAST(280.50 AS Decimal(10, 2)), 1, N'user2', 0)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (12, CAST(N'2025-07-17T18:05:40.000' AS DateTime), CAST(561.00 AS Decimal(10, 2)), 2, N'user2', 0)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (13, CAST(N'2025-07-18T12:08:28.000' AS DateTime), CAST(950.00 AS Decimal(10, 2)), 2, N'demon123', 1)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (14, CAST(N'2025-07-20T17:35:20.000' AS DateTime), CAST(1110.00 AS Decimal(10, 2)), 2, N'roblox', 1)
GO
INSERT [dbo].[Orders] ([order_id], [orderdate], [totalprice], [paymentid], [username], [status]) VALUES (15, CAST(N'2025-07-20T17:40:44.000' AS DateTime), CAST(5550.00 AS Decimal(10, 2)), 1, N'roblox', 1)
GO
...
GO
INSERT [dbo].[Products] ([id], [productname], [supplierid], [categoryid], [size], [stock], [description], [images], [colors], [releasedate], [discount], [unitSold], [price], [status], [typeid]) VALUES (6, N'ÁO SWEATSHIRT BIG LOGO ADIDAS', 1, 3, N'S,M,L,XL', 10, N'Bất kể bạn chuẩn bị tập luyện buổi sáng hay nghỉ ngơi sau một ngày dài, đã có chiếc áo sweatshirt adidas này đồng hành cùng bạn. Chất liệu vải thun da cá siêu dễ chịu cùng cổ tay và gấu áo bo gân giúp bạn luôn thoải mái và duy trì nhiệt độ hoàn hảo trong mọi hoạt động. Hãy diện chiếc áo này và sẵn sàng cho tất cả.', N'assets/home/img/products/6-1.jpg assets/home/img/products/6-2.jpg', N'Xám,Trắng', CAST(N'2023-11-01' AS Date), 0.15, 11, 875.0000, 1, 1)
GO
INSERT [dbo].[Products] ([id], [productname], [supplierid], [categoryid], [size], [stock], [description], [images], [colors], [releasedate], [discount], [unitSold], [price], [status], [typeid]) VALUES (7, N'ÁO BÓNG ĐÁ NIKE LFC M NK SSL SWOOSH TEE NAM DZ3613-010', 2, 13, N'M,L', 30, N'Chất liệu cotton mềm, nhẹ. In đồ họa tương phản với mặt trước. Cổ thuyền với tay áo ngắn. In thương hiệu logo swoosh của Nike.', N'assets/home/img/products/7-1.jpg assets/home/img/products/7-2.jpg', N'Đen', CAST(N'2023-11-01' AS Date), 0, 21, 699.0000, 1, 1)
GO
INSERT [dbo].[Products] ([id], [productname], [supplierid], [categoryid], [size], [stock], [description], [images], [colors], [releasedate], [discount], [unitSold], [price], [status], [typeid]) VALUES (8, N'QUẦN JOGGER THUN RÃ PHỐI FORM REGULAR', 3, 7, N'S,M,L,XL', 26, N'Với xu hướng bùng nổ thời trang thể thao và thời trang đường phố hiện nay thì với Quần Jogger Nam – đại diện cho phong cách Street Style ngày càng được ưa chuộng. Đặc biệt, để phù hợp cho môi trường đi làm thì Kaki là chất liệu được đánh giá là lịch sự và trang trọng hơn hẳn chất liệu thun hay nỉ. Vì vậy mà bạn có thể tự tin diện Quần Jogger Kaki vừa để đi làm vừa để đi chơi.', N'assets/home/img/products/8-1.jpg assets/home/img/products/8-2.jpg', N'Vàng', CAST(N'2025-05-01' AS Date), 0.34, 31, 425.0000, 1, 2)
GO
INSERT [dbo].[Products] ([id], [productname], [supplierid], [categoryid], [size], [stock], [description], [images], [colors], [releasedate], [discount], [unitSold], [price], [status], [typeid]) VALUES (9, N'ÁO KHOÁC GOLF ADIDAS HYBRID-SPACER', 1, 4, N'S,M,L', 30, N'Bắt đầu buổi chơi trong phong cách thanh thoát với chiếc áo khoác golf adidas này. Cấu trúc hybrid kết hợp hai lớp vải được bố trí hợp lý để giữ ấm, cùng độ co giãn tăng cường tại những vị trí cần thiết nhất để bạn vận động tối ưu trên sân golf. Các túi giúp giữ ấm đôi tay giữa những cú đánh và cất các vật dụng nhỏ khi chơi.', N'assets/home/img/products/9-1.jpg assets/home/img/products/9-2.jpg', N'Đen,Nâu', CAST(N'2025-06-01' AS Date), 0.41, 51, 2660.0000, 1, 1)
GO
INSERT [dbo].[Products] ([id], [productname], [supplierid], [categoryid], [size], [stock], [description], [images], [colors], [releasedate], [discount], [unitSold], [price], [status], [typeid]) VALUES (10, N'ÁO BÓNG ĐÁ NIKE AS M NK DF FC LIBERO HOODIE', 2, 13, N'S,M,L,XL', 20, N'Áo bóng đá nike AS M NK DF FC LIBERO HOODIE nam DC9076-010', N'assets/home/img/products/10-1.jpg assets/home/img/products/10-2.jpg', N'Đen', CAST(N'2023-12-01' AS Date), 0, 5, 1053.0000, 1, 1)
GO
INSERT [dbo].[Products] ([id], [productname], [supplierid], [categoryid], [size], [stock], [description], [images], [colors], [releasedate], [discount], [unitSold], [price], [status], [typeid]) VALUES (11, N'TRAVIS SCOTT CACT.US CORP X NIKE U NRG BH LONG SLEEVE T', 2, 3, N'S', 15, N'Hoạt động trong nhà/ngoài trời.', N'assets/home/img/products/11-1.jpg assets/home/img/products/11-2.jpg', N'Đen', CAST(N'2023-12-01' AS Date), 0, 5, 1053.0000, 1, 1)
GO
INSERT [dbo].[Products] ([id], [productname], [supplierid], [categoryid], [size], [stock], [description], [images], [colors], [releasedate], [discount], [unitSold], [price], [status], [typeid]) VALUES (12, N'ÁO THUN OVERSIZED *RETRO 9AS*', 5, 2, N'S,M,L', 33, N'100% COTTON, 320GSM, IN LỤA THỦ CÔNG, OVERSIZED FIT', N'assets/home/img/products/12-1.jpg assets/home/img/products/12-2.jpg', N'Trắng', CAST(N'2025-01-01' AS Date), 0, 72, 555.0000, 1, 1)
GO
INSERT [dbo].[Products] ([id], [productname], [supplierid], [categoryid], [size], [stock], [description], [images], [colors], [releasedate], [discount], [unitSold], [price], [status], [typeid]) VALUES (13, N'QUẦN JEANS THIÊN THẦN PHUN SƠN', 5, 8, N'S,M,L', 30, N'VẢI CHÍNH: 100% SỢI BÔNG – COTTON, MẪU CAO 1M76 68KG MẶC SIZE 32', N'assets/home/img/products/13-1.jpg assets/home/img/products/13-2.jpg', N'Xanh dương', CAST(N'2020-11-01' AS Date), 0.31, 51, 325.0000, 1, 2)
GO
...
GO
INSERT [dbo].[Users] ([id], [firstname], [lastname], [email], [avatar], [username], [password], [address], [phone], [roleid], [status]) VALUES (2, N'admin', N'123456789', N'admin@gmail.com', N'assets/home/img/users/user.jpg', N'admin123', N'e10adc3949ba59abbe56e057f20f883e', N'Cần Thơ, Việt Nam', N'0815255855', 1, 1)
GO
INSERT [dbo].[Users] ([id], [firstname], [lastname], [email], [avatar], [username], [password], [address], [phone], [roleid], [status]) VALUES (6, N'aka', N'demon', N'tuanlace180905@fpt.edu.vn', N'assets/img/users/user.jpg', N'demon123', N'fcea920f7412b5da7be0cf42b8c93759', N'Cần Thơ, Việt Nam', N'0815255855', 2, 1)
GO
INSERT [dbo].[Users] ([id], [firstname], [lastname], [email], [avatar], [username], [password], [address], [phone], [roleid], [status]) VALUES (9, N'MInh', N'Tien', N'minhtien@gmail.com', N'assets/img/users/user.jpg', N'roblox', N'e10adc3949ba59abbe56e057f20f883e', N'Đồng Tháp', N'0815255855', 2, 1)
GO
INSERT [dbo].[Users] ([id], [firstname], [lastname], [email], [avatar], [username], [password], [address], [phone], [roleid], [status]) VALUES (3, N'Anh', N'Tuan', N'tuanlace180905@fpt.edu.vn', N'assets/home/img/users/anhtuan.jpg', N'tuancsp1505', N'e10adc3949ba59abbe56e057f20f883e', N'Ninh Kiều, Cần Thơ, Việt Nam', N'0815255855', 1, 1)
GO
...
GO
INSERT [dbo].[Users] ([id], [firstname], [lastname], [email], [avatar], [username], [password], [address], [phone], [roleid], [status]) VALUES (4, N'Bé', N'Iu', N'beiudethuong@gmail.com', N'assets/home/img/users/user1.jpg', N'user2', N'e10adc3949ba59abbe56e057f20f883e', N'Cần Thơ, Việt Nam', N'0666666666', 2, 1)
GO
...
GO
ALTER TABLE [dbo].[Orders]  WITH NOCHECK ADD FOREIGN KEY([username])

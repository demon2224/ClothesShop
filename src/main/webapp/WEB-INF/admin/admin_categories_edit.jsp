...
<html lang="vi">
    <head>
        <title>Chỉnh sửa danh mục | Quản trị Admin</title>
        <meta charset="utf-8">
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item"><a href="categorymanagement">Danh sách danh mục</a></li>
                ...
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <form class="row" action="categorymanagement" method="post">
                                <input type="hidden" name="action" value="Update">
                                <input type="hidden" name="categoryId" value="${categoryId}">
                                <div class="form-group col-md-6">
                                    <label class="control-label">Tên danh mục</label>
                                    <input class="form-control" required name="categoryName" type="text" value="${categoryName}">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <a class="btn btn-cancel" href="categorymanagement">Hủy bỏ</a>
                                </div>
                            </form>
                        </div>
                    </div>
